    ...
    <div class="tab-pane active" role="tabpanel" id="step1">
                            ...
                            <div class="col-xs col col-sm col-md-7 col-lg col-xl-6 filter-all-left">
                                ...
                                <form class="needs-validation" novalidate="">
                                    ...
                                    <div class="form-group col-xs col col-sm col-md col-lg col-xl-11 flex number-page-2">
                                        ...
                                        <select id="inputname8" v-model="one_color_toner" class="form-control form-option select-size color-border">
                                            <option selected="" class="opti" value="text"> متن </option>
                                            <option value="text_picture"> متن و تصویر  </option>
                                            <option value="picture">  تصویر  </option>
                                        </select>
        ...
        <div class="col-xs col- col-sm- col-md- col-lg- col-xl-12 send-input" style="display: flex;align-items: center;justify-content: flex-end;height: 45px;">
            <div class="col-xs col-4 col-sm-3 col-md-2 col-lg-1 col-xl-1 send-input-inside" style="height: 45px;background-color:#7c1065;;border-radius: 5px;display: flex;align-items: center;justify-content: flex-end;margin-left: 120px">
                <router-link v-if="link === 1" style="width: 110px;color: #fff;text-align: center;" to="/order/upload-files">بعدی</router-link>
                <router-link v-if="link === 2" style="width: 110px;color: #fff;text-align: center;" to="/order/register">بعدی</router-link>
            </div>
        </div>
    </div>
